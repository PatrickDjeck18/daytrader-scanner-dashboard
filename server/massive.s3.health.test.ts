...
describe("Massive flat-file health", () => {
  beforeEach(() => {
    vi.stubEnv("MASSIVE_S3_ENDPOINT", "https://example.invalid");
    vi.stubEnv("MASSIVE_S3_BUCKET", "unit-test-bucket");
    vi.stubEnv("MASSIVE_S3_ACCESS_KEY_ID", "unit-test-access-key");
    vi.stubEnv("MASSIVE_S3_SECRET_ACCESS_KEY", "unit-test-secret");
  });
