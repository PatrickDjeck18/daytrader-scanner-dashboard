...
export async function savePaperBotConfig(userId: number, input: { symbols: string[]; strategy: "scalp_momentum" | "fast_momentum" | "range_reversion"; scheduleMinutes: number; riskPct: number; dailyLossStopPct: number; maxOpenPositions: number; enabled?: boolean }) {
